...
<head id="head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function formatDate(input) {
            ...
            var day = sanitized.substr(0, 2);
            var month = sanitized.substr(2, 2);
            var year = sanitized.substr(4, 4);
        ...
        <table style="background-color: #e2ded6;width:100%">
            ...
            <tr style="color: #333333; background-color: #e2ded6" align="left" >
                ...
                <td colspan="2" rowspan="2" >
                    <asp:FileUpload ID="fupImportarTerceiros" runat="server" TabIndex="12" Enabled="False" Visible="False" />
                </td>
                <td rowspan="2" >
                    <asp:Button ID="btnImportarTerceiros" runat="server" CssClass="INPUTTEXTBLACK" Text="Importar Terceiros" Width="120px" OnClick="btnImportarTerceiros_Click"  TabIndex="13" Enabled="False" Visible="False" />
                </td>
                <td rowspan="2" >
        ...
        <table>
            <tr>
                <td >
                    &nbsp;</td>
                <td >
                    <asp:Button ID="btnAlterarVlrCiot" runat="server" CssClass="INPUTTEXTBLACK" Text="Alterar valor CIOT" Width="120px"  TabIndex="13" Enabled="False" Visible="False" />
                </td>
                <td >
                    <asp:Button ID="btnVisualizarXml" runat="server" CssClass="INPUTTEXTBLACK" Text="Visualizar XML" Width="120px" OnClick="btnVisualizarXml_Click"  TabIndex="13" />
                </td>
                <td >
                    <asp:Button ID="btnCancelaCiot" runat="server" CssClass="INPUTTEXTBLACK" Text="Cancelar CIOT" Width="120px"   TabIndex="13" OnClick="btnCancelaCiot_Click" />
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td><asp:TextBox ID="dtaIni" runat="server" CssClass="INPUTTEXTBLACK" Width="120px" onkeyup="formatDate(this);" MaxLength="10"></asp:TextBox></td>					
	<td><asp:TextBox ID="dtaFin" runat="server" CssClass="INPUTTEXTBLACK" Width="120px" onkeyup="formatDate(this);" MaxLength="10"></asp:TextBox></td>					     	
